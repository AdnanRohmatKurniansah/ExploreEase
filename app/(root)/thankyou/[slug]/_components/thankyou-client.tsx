    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="bg-white shadow-lg rounded-2xl max-w-md w-full p-8 text-center">
        ...
        <p className="text-gray-600 mb-4">
          Your payment <strong>successfully</strong>
        </p>
        ...
        <Link href="/" className="mt-6 inline-block bg-green-600 text-white px-6 py-2 rounded-lg hover:bg-green-700 transition">Back to Home</Link>
      </div>
    </div>
  )
}
